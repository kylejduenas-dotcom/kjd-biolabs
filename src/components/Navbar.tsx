        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button
              ...
              className="relative ml-1 p-3 rounded-full text-slate-600 hover:text-ink-950 hover:bg-slate-100/70 transition-colors"
            >
          ...
          <button
            ...
            className="md:hidden text-ink-950 p-2.5"
